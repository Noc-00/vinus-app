...
const PopoverContent = React.forwardRef(({ className, align = "center", sideOffset = 8, ...props }, ref) => (
  <PopoverPrimitive.Portal>
    <PopoverPrimitive.Content
      ...
      className={cn(
        "z-50 w-80 overflow-hidden rounded-[2rem] border border-border/40 bg-background/80 backdrop-blur-xl p-6 text-popover-foreground shadow-2xl outline-none transition-all",
